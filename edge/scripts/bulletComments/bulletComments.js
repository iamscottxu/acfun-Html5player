...
let BulletComments = function (element, option, renderMode = "css3") {
    ...
    this.addBulletComment = function (bulletComment) {
        ...
        bulletComment.uuid = setValue(bulletComment.uuid, UUID.create().toString()); //uuid
    ...
    function refresh() {
        ...
        if (canvas == null) drawOnTheDIV();
        else drawOnTheCanvas();
    ...
    function drawOnTheDIV() {
        bulletCommentsOnScreen.forEach((bulletCommentOnScreen) => {
            bulletCommentOnScreen.element.style.transform =
                'translate(' + bulletCommentOnScreen.x + 'px,' + (bulletCommentOnScreen.actualY - 3) + 'px)';
        }, true);
    }
    ...
    function drawOnTheCanvas() {
        ...
        bulletCommentsOnScreen.forEach((bulletCommentOnScreen) => {
            ...
            if (bulletCommentOnScreen.bulletComment.color != null) {
                canvasContext.shadowBlur = option.shadowBlur + 0.5;
                canvasContext.fillStyle = bulletCommentOnScreen.bulletComment.color;
                canvasContext.fillText(bulletCommentOnScreen.bulletComment.text, bulletCommentOnScreen.x, bulletCommentOnScreen.actualY);
            }
            if (bulletCommentOnScreen.bulletComment.borderColor != null) {
                canvasContext.shadowBlur = 0;
                canvasContext.lineWidth = 0.5;
                canvasContext.strokeStyle = bulletCommentOnScreen.bulletComment.borderColor;
                canvasContext.strokeText(bulletCommentOnScreen.bulletComment.text, bulletCommentOnScreen.x, bulletCommentOnScreen.actualY);
            }
            if (bulletCommentOnScreen.bulletComment.boxColor != null) {
                canvasContext.shadowBlur = 0;
                canvasContext.lineWidth = 1;
                canvasContext.strokeStyle = bulletCommentOnScreen.bulletComment.boxColor;
                canvasContext.strokeRect(bulletCommentOnScreen.x - 4, bulletCommentOnScreen.actualY - 4,
    ...
    function addBulletCommentsToScreen() {
        ...
        do {
            ...
            if (bulletComment.startTime > nowTime - 1 / refreshRate)
    ...
    function creatBulletCommentDiv(bulletCommentOnScreen) {
        ...
        element.style.font = "700 " + bulletCommentOnScreen.size + "px sans-serif";
        element.style.padding = '0 4px 0 4px';
        //element.style.height = bulletCommentOnScreen.size + 'px';
        element.style.textShadow = '0 0 ' + option.shadowBlur + 'px black';
        if (bulletComment.color == null) element.style.color = 'rgba(0,0,0,0)';
        else element.style.color = bulletComment.color;
        if (bulletComment.borderColor != null) element.style.webkitTextStroke = '0.5px ' + bulletComment.borderColor;
        if (bulletComment.boxColor != null) element.style.border = '1px solid ' + bulletComment.boxColor;
    ...
    function getBulletCommentOnScreen(nowTime, bulletComment) {
        ...
        if (canvas == null) {
            bulletCommentOnScreen.element = creatBulletCommentDiv(bulletCommentOnScreen);
