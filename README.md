...
>#### Edge未上架扩展手动加载方法
>
>鉴于很多小伙伴询问Edge怎么使用扩展，这里说明下。点击`Clone or download -> Download ZIP`下载。下载解压缩后，打开Edge浏览器，点击`右上角有三个点图标的菜单 -> 扩展 -> 加载扩展`，在打开的窗口中选择`edge\Extension`文件夹，即可使用扩展。（Ps：Windows 10早期版本并不支持扩展加载，请更打开Windows自动更新，并更新到最新版本）。
>
